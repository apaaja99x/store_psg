                                            ...
                                            <table class="table" id="data" width="100%">
                                                <thead class="text-primary">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('image/'.$item->picture)}}" width="50px">
                                                    </td>
                                                    <td>
                                                        <a href="{{ url('product/'.$item->id)}}/edit" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>
                                                        <a href="{{ url('delete', $item->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-xs btn-warning"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                        @endforeach
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right">
                        ...
                        <a href="http://www.creative-tim.com">Developed by</a>, Students of SMKN 2 MOJOKERTO
                    </p>
                </div>
            </footer>
        </div>
