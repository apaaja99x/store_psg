      ...
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand">
            <img src="{{ asset('shop/image/mazoa.png')}}" alt="" style="width:150px; margin:-7px; margin-left:30px;">
          </a>
        </div>
      </div>
    </nav>
              ...
              <div class="tab-2">
                ...
                <div>
                  ...
                  <div class="group">
                    ...
                    <input id="name" class="insert" type="text" name="name" value="{{ old('name')}}" required="">
                  ...
                  <div class="group">
                    ...
                    <input id="email" class="insert" type="email" name="email" value="{{ old('email')}}" required="">
                  ...
                  <div class="group">
                    <input id="password-confirm" class="insert" type="password" name="password_confirmation" required="">
